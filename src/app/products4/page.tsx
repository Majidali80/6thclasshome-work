  ...
  return (  
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center p-6 flex-grow">
        <h1 className="text-3xl font-bold mb-4">Hyundai Sonata 2.5 2024 Price in Pakistan, Specs & Features
        </h1>
        <img src="/sonata.jpg" alt="Product" className="w-64 h-auto mb-4" />
        ...
        <b>MILEAGE</b> (KM/LITER) 9 to 13 <b>Transmission Automatic</b> (AT) <b>Fuel Type</b> Petrol <b>Engine</b> 2497 cc  </p>

        <p className="text-xl text-green-600 font-bold mb-4">PKR 11,205,000</p>
