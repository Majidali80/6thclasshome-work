  ...
  return (  
    <div className="flex flex-col min-h-screen">
      ...
      <div className="flex flex-col items-center p-6 flex-grow">
        <h1 className="text-3xl font-bold mb-4">Toyota Corolla Altis X Manual 1.6 2024 Price in Pakistan, Specs & Features
        </h1>
        <img src="/toyota.jpg" alt="Product" className="w-64 h-auto mb-4" />
        ...
        <b>MILEAGE</b> (KM/LITER) 12 to 15 <b>Transmission</b> Manual <b>Fuel Type</b> Petrol <b>Engine</b> 1598 cc
        </p>

        <p className="text-xl text-green-600 font-bold mb-4">PKR 5,969,000</p>
